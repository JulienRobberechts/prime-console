...
const errors = {
  TooSmallLimit: 'Can not create the primes table for a value < 2',
  TooLargeLimit: 'Can not create the primes table for a value > 100 000 000',
};
...
const findPrimes = (limit) => {
  ...
  if (limit <= 1) {
    throw Error(errors.TooSmallLimit);
  }

  if (limit > 100000000) {
    throw Error(errors.TooLargeLimit);
  }
