...
const errors = {
  TooLowInputValue: 'Can not create the primes table of a negative or zero value',
  TooBigInputValue: 'Can not create the primes table for a value > 100 000 000',
};
...
const findPrimes = (limit) => {
  ...
  if (limit <= 1) {
    throw Error(errors.TooLowInputValue);
  }

  if (limit > 100000000) {
    throw Error(errors.TooBigInputValue);
  }
